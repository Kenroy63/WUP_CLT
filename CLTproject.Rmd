...
Take the standard deviation and put in the data that is from the central limit. the standard deviation shrinks as the number gets higher example 4 divided by 2, 9 is divided by 3. 16 divided by 4 and son on. The standard deviation "r not". The expected value is the mean will always stay the same and the standard deviation will always shrink. This numb is a demonstration of what happens.
'r sd(my1000$k3)'
